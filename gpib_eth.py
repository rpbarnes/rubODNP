...
class eip_powermeter ():
    ...
    def read_power(self):
        ...
        return power
    def close(self):
        self.g.write('DA')# turn on the display
        self.g.write('HP')# if we don't do this, the display freezes
        self.g.write('RP')# no longer output only mode
        self.g.write('FP')# turn off "fast mode"??
        self.g.write('R0')# switch back to high res
        del self.g
